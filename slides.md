...
<div class="rounded-lg aspect-video flex flex-col items-center justify-center text-gray-500">
  ...
  <div class="text-sm mb-2">出典: https://www.youtube.com/watch?v=RXgp4cDbiq4</div>
</div>
...
<div class="rounded-lg aspect-video flex flex-col items-center justify-center text-gray-500">
  ...
  <div class="text-sm mb-2">出典: https://gmo-cybersecurity.com/blog/defconctf2019_interview/</div>
</div>
